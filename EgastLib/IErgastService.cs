...
public interface IErgastService
{
    ...
    /// <param name="race">The number of the race in the season. Default is `last`.</param>
    /// <returns>The race summary with lap times and race information</returns>
    Task<RaceSummary> RaceSummaryAsync(int season = 0, int race = 0);
    ...
    Task<RaceData> GetLapTimeAsync(int season = 0, int race = 0);
    ...
    Task<IEnumerable<Driver>> GetDriversAsync(int season = 0, int race = 0);
